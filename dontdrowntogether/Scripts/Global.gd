...
const grunka_spawn_min : float = 0.25
const grunka_spawn_max : float = 1.0

const grunka_xvel : float = 50.0 # Initial speed in x direction (in random range + to -)
const grunka_yvel_min : float = 100.0 # Initial speed in y direction
const grunka_yvel_max : float = 300.0 # Initial speed in y direction
...
const stone_spawn_min : float = 5.0
const stone_spawn_max : float = 10.0
...
const river_acc : float = 0.1 # Amount that river_force increases every second
